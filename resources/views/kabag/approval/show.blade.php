...
<div class="max-w-4xl mx-auto space-y-6 animate-fade-in">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white">Review Pengajuan</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="glass-card">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between"><span class="text-gray-400">Status</span><span class="badge-{{ $pengajuan->kendaraan->status_color }}">{{ $pengajuan->kendaraan->label_status }}</span></div>
            </div>
        </div>
    </div>
    ...
    <div class="glass-card">
        <h3 class="text-lg font-bold text-white mb-4">Keputusan</h3>
