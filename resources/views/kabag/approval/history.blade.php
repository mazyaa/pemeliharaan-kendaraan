@extends('layouts.app')
@section('title', 'Riwayat Approval Kepala Bagian')

@section('content')
<div class="space-y-6 animate-fade-in">
    <div>
        <h1 class="text-2xl font-bold text-gray-800">Riwayat Approval</h1>
        <p class="text-gray-500 text-sm mt-1">Pengajuan yang telah disetujui atau ditolak</p>
    </div>
        ...
        <form method="GET" class="flex flex-wrap gap-3 items-end">
            ...
            <div class="w-auto">
                ...
                <select name="status" class="glass-select">
                    ...
                    <option class="text-black" value="rejected_kabag" {{ request('status') == 'rejected_kabag' ? 'selected' : '' }}>Ditolak Kabag</option>
                ...
                <tr>
                    <td colspan="7">
                        <div class="empty-state">
                            ...
                            <p class="empty-text">Tidak ada riwayat approval</p>
                        </div>
                    </td>
                </tr>
                @endforelse
