...
<div class="space-y-6 animate-fade-in" x-data="roleManager()">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">Kelola role pengguna sistem</p>
        </div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                    <td class="py-3 px-4 text-gray-700">{{ $roles->firstItem() + $index }}</td>
                    <td class="py-3 px-4 font-medium text-gray-800">{{ $role->name }}</td>
                    <td class="py-3 px-4 text-gray-700">{{ $role->description }}</td>
                    <td class="py-3 px-4">
    ...
    <div class="md:hidden space-y-3">
        ...
        <div class="glass-card p-4">
            <div class="flex justify-between items-start mb-2">
                <span class="font-semibold text-gray-800">{{ $roles->firstItem() + $index }}</span>
            </div>
        ...
        @endforelse
        <div class="p-4">{{ $roles->withQueryString()->links() }}</div>
    </div>
    ...
    <div x-show="createModal" class="modal-backdrop" x-cloak>
        <div class="modal-content" @click.outside="createModal = false">
            <div class="modal-header">
                <h3 class="text-lg font-bold text-gray-800">Tambah Role</h3>
