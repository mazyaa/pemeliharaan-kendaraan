@extends('layouts.app')
@section('title', 'Riwayat Approval PPTK')

@section('content')
<div class="space-y-6 animate-fade-in">
    <div>
        <h1 class="text-2xl font-bold text-white">Riwayat Approval PPTK</h1>
        <p class="text-gray-400 text-sm mt-1">Pengajuan yang telah disetujui atau ditolak</p>
    </div>
